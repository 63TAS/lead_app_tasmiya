...
Uri.parse('https://b1.bhaaraterp.com/leads/api/lead-profile-section-update/'),
...
request.files.add(
  await http.MultipartFile.fromPath('user_profile_image', '$xImage!.path'));
...
try{
  var response = await http.get(
    Uri.parse('https://b1.bhaaraterp.com/leads/api/lead-city-list-api/?state_id=135'),
headers: {
  'token':'6fba84eba684a66dfd52213a34327e14dfffb322',
},
);
...
try{
  var response = await http.get(
    Uri.parse('https://b1.bhaaraterp.com/leads/api/contact/?store_id=1&user_id=486&search_value=$id'),
headers: {
  'token':'6fba84eba684a66dfd52213a34327e14dfffb322',
},
);
...
try{
var response =  await  http.get(
  Uri.parse('https://b1.bhaaraterp.com/leads/api/lead-state-list-api/?country_id=10'),
  headers: {
...
try{
var response =  await  http.get(
  Uri.parse('https://b1.bhaaraterp.com/leads/api/contact/?store_id=1&user_id=486&search_value=$query'),
  headers: {
    'token':'6fba84eba684a66dfd52213a34327e14dfffb322',
...
Future<List<dynamic>> getFilterData()async{
try{
...
try{
var response =  await  http.get(
  Uri.parse('https://b1.bhaaraterp.com/leads/api/fav-contact-list/?store_id=1&user_id=486'),
  headers: {
  ...
  print('taasmiya favoirtes: ${favoritesData}');
